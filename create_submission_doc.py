...
for row, (label, value) in zip(meta.rows, [("Candidate", "Madhavik Dogra"),("Repository", "[Add GitHub repository URL before submission]"),("Deployment", "[Add Vercel deployment URL before submission]")]):
